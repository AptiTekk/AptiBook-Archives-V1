...
public class FileUploadUtilities {
    ...
    public static final File UPLOADS_DIR = new File(System.getProperty("jboss.server.data.dir"), "Agenda_Uploads");
    ...
    /**
     * Uploads an image to a specified name.
     *
     * @param imagePart The Part from the fileInput
     * @param fileName  The new file name of the upload.
     * @throws IOException
     */
    ...
    /**
     * Uploads an image to a specified name, and crops and/or resizes it to a
     * desired width, using a 1:1 aspect ratio.
     *
     * @param imagePart    The Part from the fileInput
     * @param fileName     The new file name of the upload.
     * @param desiredWidth The desired width for the image. (Will also be height; 1:1
     *                     aspect ratio)
     * @throws IOException
     */
